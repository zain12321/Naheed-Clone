...
import Kitchen from '../components/Kicthen'
import Mensshow from '../components/Mensshow'
import Womansitem from '../components/womansitem'
...
<div className='flex items-center justify-center space-x-2  xl:pl-11'>
    <Link href='/'>
    <a>
    <div className='flex items-center text-[#FFFFFF] space-x-2 w-[105px]'>
        {/* <GoPerson className='h-7 w-7 '/> */}
       <img className='h-7 w-7 rounded-full' src="https://pps.whatsapp.net/v/t61.24694-24/294997810_1176312363283121_1787894006439940867_n.jpg?ccb=11-4&oh=01_AVyhr2U612Fzcv6itmWjKv27NaT8BYM3GtK3vFOfP4XfPw&oe=62FE9FC3" alt="" />
